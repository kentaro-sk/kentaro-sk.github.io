...
const ACHIEVEMENTS = [
  ...
  {
    /* 自動車技術会（JSAE）2024年春季大会 第7回学生ポスターセッション。
       会期: 2024年5月22–24日、会場: パシフィコ横浜ノース。
       発表番号66として登壇し、可誘導性に連なる研究をポスター発表した。 */
    category:     'Conference',
    title:        '行動モデルに基づく歩行者間の相互影響度定量化指標の提案',
    organization: '自動車技術会（JSAE）2024年春季大会 第7回学生ポスターセッション',
    dateLocation: '2024年5月22–24日 / パシフィコ横浜ノース',
    year:         2024,
    description:  '発表番号66として学生ポスターセッションに登壇。'
                + '歩行者の行動モデルに基づき、歩行者間の相互影響度を定量化する指標を提案した'
                + '（「可誘導性」の研究に連なる内容）。',
    url:          'https://www.jsae.or.jp/taikai/2024haru/student-poster-entry/',
    highlight:    false
  },
