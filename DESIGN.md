...
- 方針転換の途中段階: WORKSの詳細ページ(AI×仕事 / AI×教育)・HOBBYの詳細ページ(CASTLES / TRAVEL / BASEBALL)は書体のみ`.u-display`へ転換済みで、カード・影・角丸・配色は旧方針のまま。ページごとにレイアウトの新旧が混在している。
